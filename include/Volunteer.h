...
class Volunteer {
    public:
        ...
        virtual ~Volunteer(); // Virtual destructor
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        void setTimeLeft(int time); //set the time left for the volunteer to finish
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        int decNumOrdersLeft(); //decrease the ordersLeft field of the limited volunteer
        string toString() const override;
